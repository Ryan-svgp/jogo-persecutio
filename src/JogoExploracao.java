            ...
            // INTERAÇÕES NO MUNDO UMBRA (Pesadelo)
                ...
                // Olhar o Espelho e pegar a Peça 1
                    ...
                    if (!pegouPecaEspelho) {
                        ...
                        mensagemAviso = "Você encontrou um fragmento de um objeto circular no reflexo do espelho!";import javax.swing.*;
import javax.sound.sampled.*;
import java.io.File;
import java.awt.*;
import java.awt.event.*;
...
public class JogoExploracao extends JPanel implements KeyListener {
    ...
    public JogoExploracao() {
        ...
        imgPorta2 = new ImageIcon("img/parte3.png").getImage();
        imgPorta3 = new ImageIcon("img/parte4.png").getImage();
        imgReflexo = new ImageIcon("img/reflexo-espelho.jpeg").getImage();
    ...
    public void paintComponent(Graphics g) {
        ...
        if (!mundoUmbra) {
            ...
            if (imgNPC != null) {
                int npcX = 1600; // Mude para mover o desenho para os lados
                int npcY = 300;  // Mude para mover o desenho para cima/baixo
                g2d.drawImage(imgNPC, cameraX + npcX, cameraY + npcY, 50, 70, this);
            }
        ...
        if (mostrandoEspelho) {
            ...
            g2d.drawImage(imgReflexo, px, py, imgTamanhoX, imgTamanhoY, this);
                ...
                // Abrir a Gaveta, digitar a senha e pegar Peça 2 + Palavra
                    ...
                    if (!pegouPecaGaveta) {
                        ...
                        if (senha != null && senha.equals("0410")) {
                            ...
                            mensagemAviso = "Você achou um fragmento de um objeto circular e um bilhete com a palavra 'Redenção'.";
