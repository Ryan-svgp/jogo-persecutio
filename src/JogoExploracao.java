...
public class JogoExploracao extends JPanel implements KeyListener {
    ...
    public JogoExploracao() {
        ...
        imgEspelho = new ImageIcon ("img/reflexo-espelho.jpeg").getImage();
    ...
    public void paintComponent(Graphics g) {
        ...
        if (!mundoUmbra) {
            ...
            if (imgNPC != null) {
                ...
                g2d.drawImage(imgNPC, cameraX + npcX, cameraY + npcY, 64, 64, this);
            }
            ...
            if (imgEnfermeira != null) {
                ...
                g2d.drawImage(imgEnfermeira, cameraX + enfermeiraX, cameraY + enfermeiraY, 64, 64, this);
            }
        }
        ...
        if (mostrandoEspelho) {
        	...
        	g2d.drawImage(imgEspelho, px, py, imgEspelho.getWidth(this), imgEspelho.getHeight(this), this);
